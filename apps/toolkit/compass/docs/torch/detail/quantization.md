...
![compare_output.png](../../../../../../apps/toolkit/compass/docs/torch/_images/compare_output.png)
...
Currently, PyTorch only has eager mode quantization as an alternative: [Static Quantization with Eager Mode in PyTorch](../../../../../../apps/toolkit/compass/docs/torch/detail/link-to-eager-mode-tutorial).
...
We’ll start by doing the necessary imports, defining some helper functions, and preparing the data. These steps are identical to [Static Quantization with Eager Mode in PyTorch](../../../../../../apps/toolkit/compass/docs/torch/detail/link-to-eager-mode-tutorial).

To run the code in this tutorial using the entire ImageNet dataset, first download imagenet by following the instructions at [ImageNet Data](../../../../../../apps/toolkit/compass/docs/torch/detail/link-to-imagenet-data). Unzip the downloaded file into the ‘data_path’ folder.
