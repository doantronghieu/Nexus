...
from context.infra.services_info import PORT_APP_LLM_P3
from services.llm.agents.p3.manager import agent_main
...
if __name__ == "__main__":
    import uvicorn
    uvicorn.run(app, host="0.0.0.0", port=int(PORT_APP_LLM_P3))
