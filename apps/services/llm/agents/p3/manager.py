...
#*==============================================================================
# from services.llm.agents.p3.child
#*==============================================================================
from services.llm.agents.p3.context import (
	prompts_agents_p3, prompts_agent_main
)
...
class AgentMain(agents.AgentBase):
	...
	async def categorize_query(user_query: str) -> T_USER_QUERY_CATEGORY:
		...
		prompt = prompts_lc.PromptTemplate.from_template(prompts_agents_p3["categorize_query"])
	...
	# 		prompt_tpl = prompts_lc.PromptTemplate.from_template(prompts_agents_p3["system"])
