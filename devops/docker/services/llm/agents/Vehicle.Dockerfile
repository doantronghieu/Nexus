...
COPY apps/requirements/dev.langchain.requirements.txt .
RUN pip install --no-cache-dir -r dev.langchain.requirements.txt
...
WORKDIR /apps/services/llm/agents/vehicle/
